...
class AAIT_Payex2_Block_Info extends Mage_Payment_Block_Info
{
    protected function _construct()
    {
        parent::_construct();

        $this->setTemplate('payex2/info.phtml');
        // Template for Checkout page
        if ($this->getRequest()->getRequestedActionName() === 'progress') {
            $this->setTemplate('payex2/title.phtml');
        }
    ...
    {
        $this->setTemplate('payex2/pdf/info.phtml');
        return $this->toHtml();
    }
}
