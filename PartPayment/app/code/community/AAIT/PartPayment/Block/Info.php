...
class AAIT_PartPayment_Block_Info extends Mage_Payment_Block_Info
{
    protected function _construct()
    {
        parent::_construct();

        $this->setTemplate('partpayment/info.phtml');
        // Template for Checkout page
        if ($this->getRequest()->getRequestedActionName() === 'progress') {
            $this->setTemplate('partpayment/title.phtml');
        }
    ...
    {
        $this->setTemplate('partpayment/pdf/info.phtml');
        return $this->toHtml();
    }
}
