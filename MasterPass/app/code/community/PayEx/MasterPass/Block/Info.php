...
class PayEx_MasterPass_Block_Info extends Mage_Payment_Block_Info
{
    protected function _construct()
    {
        parent::_construct();

        $this->setTemplate('payex_mp/info.phtml');
        // Template for Checkout page
        if ($this->getRequest()->getRequestedActionName() === 'progress') {
            $this->setTemplate('payex_mp/title.phtml');
        }
    ...
    {
        $this->setTemplate('payex_mp/pdf/info.phtml');
        return $this->toHtml();
    }
}
