...
class PayEx_MasterPass_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    const URL_NEWS = 'http://payex.aait.se/application/meta/check?key=A96WPDrd9Zr954G';
    ...
    {
        return Mage::getModel('payex_mp/feed')->checkUpdate();
    }
    ...
    public function checkUpdate()
    {
        ...
        if ($feedXml && $feedXml->channel && $feedXml->channel->item) {
            ...
            if (count($availableVersions) > 0) {
                Mage::app()->saveCache(serialize($availableVersions), 'payex_mp_available_versions');
            }
        }
    ...
    {
        return Mage::app()->loadCache('payex_mp_notifications_last_check');
    }
    ...
    {
        Mage::app()->saveCache(time(), 'payex_mp_notifications_last_check');
        return $this;
    }
