...
class PayEx_Payments_Test_Model_Payment_Autopay extends EcomDev_PHPUnit_Test_Case
{
    var $object;
    ...
    {
        parent::setUp();
        $this->object = Mage::getModel('payex/payment_autopay');
    }
    ...
    {
        $this->assertAttributeEquals('payex_autopay', '_code', $this->object);
        $this->assertAttributeEquals('payex/form_autopay', '_formBlockType', $this->object);
        $this->assertAttributeEquals('payex/info_autopay', '_infoBlockType', $this->object);
