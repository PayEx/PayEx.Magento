...
class AAIT_Payexautopay_Block_Info extends Mage_Payment_Block_Info
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('payexautopay/info.phtml');
        // Template for Checkout page
        if ($this->getRequest()->getRequestedActionName() === 'progress') {
            $this->setTemplate('payexautopay/title.phtml');
        }
    }
    ...
    {
        $this->setTemplate('payexautopay/pdf/info.phtml');
        return $this->toHtml();
    }
}
